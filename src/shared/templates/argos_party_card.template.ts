...
<div class="container">
  <div class="card">
    <div class="party">
      <ul>
         <li><div><img src=%IMAGE1%> <span class="dps"> %DPS1%</span> </div></li>
         <hr>
         <li><div><img src=%IMAGE3%> <span> %ALT1%</span> </div></li>
         <li><div><img src=%IMAGE4%> <span> %ALT2%</span> </div></li>
         <li><div><img src=%IMAGE5%> <span> %ALT3%</span> </div></li>
      </ul>
    </div>
    <div class="party">
      <ul>
        <li><div><img src=%IMAGE2%> <span class="dps"> %DPS2%</span> </div></li>
        <hr>
        <li><div><img src=%IMAGE6%> <span> %ALT4%</span> </div></li>
        <li><div><img src=%IMAGE7%> <span> %ALT5%</span> </div></li>
        <li><div><img src=%IMAGE8%> <span> %ALT6%</span> </div></li>
      </ul>
    </div>
  </div>
</div>
